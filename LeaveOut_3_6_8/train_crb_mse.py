"""LeaveOut_3_6_8: UNetCRB MSE, hold-out SPARE phases 3, 6, 8."""
...
# SPARE 1-indexed 3, 6, 8 → 0-indexed 2, 5, 7
held_out_phases = [2, 5, 7]
filename = 'dans_crb_mse_lo_3_6_8'
...
print(f'[{filename}] device={device} | params={n_g/1e6:.2f}M | held_out_1idx=[3,6,8] | 0idx={held_out_phases}')
