"""UNetCRB-Decoder+Bot — plain encoder; CRB at bottleneck + decoder.

Same as DecoderCRB, but bottleneck (down5) is also a CRB.
Direct 3-ch DVF, no SVF.
"""
...
class UNetCRBDecoderBot(nn.Module):
    """Plain encoder; CRB bottleneck + CRB decoder → direct 3-ch DVF."""
    ...
    def __init__(self, im_size=128, n_phases=10):
        ...
        self.down5 = DownCRB(64, 64, cond_dim=cond_dim)  # bottleneck CRB
