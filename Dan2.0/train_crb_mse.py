"""Train Dan 2.0: UNetCRB with lung-masked MSE only (no discriminator)."""
...
# leave-out phases 5 & 9 (0-indexed 4 & 8) — match Dan CRB
held_out_phases = [4, 8]

filename = 'dans_crb_mse'
...
print(
    ...
    f'loss=lung-masked MSE | held_out={held_out_phases}'
)
print(
