"""UNetCRB-Both — Experiment 4 copy with frozen anatomy side-branch.

Code is ready; E4 does not train this arch by default.
"""
...
class UNetCRBBoth(nn.Module):
    """CRB encoder+decoder + frozen anatomy vector (E4 side-branch)."""
