"""Build patient-prefixed pooled train/test symlink trees for CRBExperiments Experiment 1.
...
PS = E1.parents[1]  # PopulationStudy (…/CRBExperiments/Experiment1 → …/PopulationStudy)
SRC = PS / "data_iso"  # P0-A common isotropic grid
POOLED = E1 / "data" / "pooled"
SEED_PATH = E1 / "seed.json"
...
def rel_symlink(src: Path, dst: Path) -> None:
    ...
    if dst.is_symlink() or dst.exists():
        dst.unlink()
    # Absolute links — relative depth breaks under CRBExperiments/.../pooled/
