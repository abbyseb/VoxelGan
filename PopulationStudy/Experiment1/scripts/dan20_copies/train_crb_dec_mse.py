"""Dan 2.0 Decoder-CRB: UNetCRBDecoder + lung-masked MSE only (no D).

Usage (from this directory):
  PYTHONPATH=.. python train_crb_dec_mse.py --held_out 5,9 --run_dir LeaveOut_5_9
"""
...
DAN20 = DEC_ROOT.parent
sys.path.insert(0, str(DAN20))
sys.path.insert(0, str(DEC_ROOT))

from generator_crb_dec import UNetCRBDecoder
...
def main():
    ...
    print(
        ...
        f'loss=lung-masked MSE | no D | CRB=decoder-only | held_out_1idx={held_1idx}'
    )
    print(
