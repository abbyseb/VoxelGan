"""Shared MSE train loop for Experiment 1 CRB models (no discriminator).

Copied and adapted from Dan2.0 Encoder/Decoder/Both CRB train scripts.
Lung-masked MSE vs Elastix DVF. Val pairs come from train patients only.
...
ARCH = {
    'encoder': {
        ...
        'filename': 'crb_enc_mse_pop_e1',
        'label': 'CRB=encoder-only',
    },
    'decoder': {
        'cls': UNetCRBDecoder,
        'run_dir': E1 / 'DecoderCRB',
        'filename': 'crb_dec_mse_pop_e1',
        'label': 'CRB=decoder-only',
    },
    'both': {
        'cls': UNetCRBBoth,
        'run_dir': E1 / 'BothCRB',
        'filename': 'crb_both_mse_pop_e1',
