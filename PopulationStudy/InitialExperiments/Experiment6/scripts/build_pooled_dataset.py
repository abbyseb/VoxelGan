"""Build patient-prefixed pooled train/test symlink trees for Experiment 6.

Uses PopulationStudy/data_iso (P0-A common isotropic grid).
...
PS = E6.parents[1]  # PopulationStudy
SRC = PS / "data_iso"
POOLED = E6 / "data" / "pooled"
SEED_PATH = E6 / "seed.json"
