"""Full-volume QC for Experiment 4 CRB models on hold-out patients.
...
Metrics = lung-masked L1 + cosine vs Elastix (same as Dan 2.0 QC).
  ...
  PYTHONPATH=.. python scripts/qc_pairs.py \\
    --arch encoder \\
    --ckpt EncoderCRB/weights/crb_enc_mse_pop_e4_generator.pth \\
