"""Build pooled train/test symlink trees for ClinicalExperiments Experiment 1.

Train uses all SPARE patients P1..P9 (full-SPARE training). Test split is empty.
Identity pairs are included.
"""
