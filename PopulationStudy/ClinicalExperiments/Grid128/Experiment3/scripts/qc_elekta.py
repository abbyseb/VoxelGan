#!/usr/bin/env python3
"""Zero-shot QC for ClinicalExperiments Experiment3 (cyclic+fov).
...
# EXP last so local cyclic nets win over InitialExperiments
...
DEFAULT_CKPTS = {
    "encoder": "EncoderCRB/weights/crb_enc_mse_cyclic_fov_aug_generator.pth",
    "decoder": "DecoderCRB/weights/crb_dec_mse_cyclic_fov_aug_generator.pth",
    "both": "BothCRB/weights/crb_both_mse_cyclic_fov_aug_generator.pth",
}
        ...
        for i, stem in enumerate(pair_stems, 1):
            ...
            if stem in panel_pairs:
                save_panel(
                    ...
                    f"{args.scan} {stem} (zero-shot {args.arch} cyclic+fov)",
                    l1, cos, k,
                )
