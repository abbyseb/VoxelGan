"""Full-volume QC for UNetCRB (View 1 + mm bars, no SI/AP labels)."""
...
def main():
    ...
    ap.add_argument('--ckpt', default=str(ROOT / 'weights' / 'dans_crb_warp_d_generator.pth'))
    ap.add_argument('--data_dir', default=str(PARENT / 'data' / 'spare' / 'all'))
    ap.add_argument('--out_dir', default=str(ROOT / 'plots' / 'qc_test_crb'))
    ap.add_argument(
        '--view_config',
